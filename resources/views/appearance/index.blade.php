            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li><a href="{{asset('appearance/properties.html')}}">Properties</a></li>
                      <li><a href="{{asset('appearance/property-details.html')}}">Property Details</a></li>
                      <li><a href="{{asset('appearance/contact.html')}}">Contact Us</a></li>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="item">
            ...
            <h6>Rp.885.600</h6>
            <h4><a href="property-details.html">Malino hihglands, OR 97219</a></h4>
            <ul>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            ...
            <span class="category">Luxury Villa</span>
            <h6>Rp.494,182</h6>
            <h4><a href="property-details.html">Rumah Kurcaci D'Sawah, OR 27001</a></h4>
            <ul>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            ...
            <span class="category">Luxury Villa</span>
            <h6>Rp.1.809.234</h6>
            <h4><a href="property-details.html">Pucuk Merah Malino, OR 38540</a></h4>
            <ul>
